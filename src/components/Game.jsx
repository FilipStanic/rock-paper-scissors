    ...
    return (
        <>
            <div className='grid place-content-center h-screen'>
                ...
                <div className='flex gap-5 justify-around mt-20'>
                    <button onClick={() => handleGame('Rock')} id='rock' className='border border-transparent rounded-lg transition-all duration-200 hover:border-gray-500 p-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-hand-grab" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button onClick={() => handleGame('Paper')} id='paper' className='border border-transparent rounded-lg transition-all duration-200 hover:border-gray-500 p-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-file-neutral" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <button onClick={() => handleGame('Scissors')} id='scissors' className='border border-transparent rounded-lg transition-all duration-200 hover:border-gray-500 p-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-scissors" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                {gameStarted ? (
                    ...
                    <div className='text-white text-2xl font-bold font-serif place-content-center text-center mt-10'>
                        Choose option...
                    </div>
                )}
            </div>
